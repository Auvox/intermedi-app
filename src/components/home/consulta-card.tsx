    ...
    <Pressable
      ...
      <View style={styles.row}>
        <View style={styles.iconSquare}>
          <PillIcon size={28} color={Colors.textOnPrimary} />
        </View>

        <View style={styles.info}>
          <AppText variant="bodyBold" numberOfLines={1}>
            {medicine.name} <AppText variant="body">{medicine.dosage}</AppText>
          </AppText>
      ...
      <Button title="Consultar" onPress={onConsultar} fullWidth={false} style={styles.button} />
    </Pressable>
  );
}
